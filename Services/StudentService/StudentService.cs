    ...
    public class StudentService : IStudentService
    {
        ...
        public BaseResponse UpdateStudentById(long id, UpdateStudentRequest request)
        {
            ...
            try
            {
                using (context)
                {
                    StudentModel filteredStudent = context.Students.Where(students => students.id == id).FirstOrDefault();
        ...
        public BaseResponse DeleteStudentById(long id)
        {
            ...
            try
            {
                using (context)
                {
                    StudentModel studentToDelete = context.Students.Where(students => students.id == id).FirstOrDefault();
        ...
        public BaseResponse GetStudentById(long id, StudentModel student)
        {
